...
```mermaid
graph TD
    A[1991 Economic Crisis] --> B[LPG Reforms]
    B --> C[Liberalization]
    B --> D[Privatization]
    B --> E[Globalization]
    C --> F[Removal of Licenses]
    D --> G[Private Entry in Telecom/Banking]
    E --> H[MNCs Enter India]
    F --> I[Massive Increase in Supply]
    G --> I
    H --> I
    I --> J[Transition to Buyers' Market]
```
